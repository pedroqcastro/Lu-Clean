import { s as UseReactCompareSliderReturn } from "./types-BOyLSqn_.cjs";
...
type HandleProps = {
  /** Optional styles for the circular element in the middle of the handle. */buttonStyle?: CSSProperties; /** Optional styles for lines either side of the handle button. */
  linesStyle?: CSSProperties;
};
type HandleDetailedProps = ComponentProps<'div'> & HandleProps;
/**
 ...
 */
declare const Handle: FC<HandleDetailedProps>;
//#endregion
...
type ContextProps = UseReactCompareSliderReturn;
 ...
 * ```
 */
declare const useReactCompareSliderContext: () => ContextProps;
//#endregion
export { Image as a, HandleDetailedProps as c, useReactCompareSliderContext as i, HandleProps as l, Provider as n, ImageProps as o, ProviderProps as r, Handle as s, ContextProps as t };
//# sourceMappingURL=provider-xdjxNCiT.d.cts.map