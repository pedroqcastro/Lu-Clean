import { o as UseReactCompareSliderProps, s as UseReactCompareSliderReturn } from "./types-BOyLSqn_.cjs";
 ...
 */
declare const useReactCompareSlider: ({
  boundsPadding,
  browsingContext,
